...
import pytest
from source_cin7_core.source import Cin7CoreStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(Cin7CoreStream, "path", "v0/example_endpoint")
    mocker.patch.object(Cin7CoreStream, "primary_key", "test_primary_key")
    mocker.patch.object(Cin7CoreStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = Cin7CoreStream()
